...
Two vocabulary debts identified during ₣Ax (bottle lifecycle vocabulary) work that are too large or orthogonal to include there. Both are deletion/simplification work — removing concepts that don't carry their weight.
...
- ₣Ax paddock (tally/ordain decisions, ark discussion)
