...
The following paces were not completed and are being abandoned. The architecture has been superseded by the JJR Gallops Core redesign, which shifts from a Bash v2 implementation to a Rust-based backend with modular git-native operations.

- **studbook-v2-schema-validation** — v1 Bash implementation (superseded)
- **studbook-v2-write-ops** — v1 Bash implementation (superseded)
- **studbook-v2-read-ops** — v1 Bash implementation (superseded)
- **studbook-v2-workflow-ops** — v1 Bash implementation (superseded)
- **studbook-v2-code-cleanup** — v1 Bash implementation (superseded)
- **jju-modularization-review** — v1 Bash architecture (superseded)
- **jju-modularization-execute** — v1 Bash architecture (superseded)
- **jj-arcanum-finalize** — v1 Bash architecture (superseded)
- **Vocabulary cleanup** — v1 vocabulary (superseded)
- **Documentation** — v1 documentation (superseded)
- **Test full workflow** — v1 workflow (superseded)

## Successor Heat

**JJR Gallops Core** (`b260112`) is the direct successor to this heat. The Gallops redesign shifts from a Bash v2 implementation to a Rust-based backend with modular git-native operations. All architecture decisions and incomplete work from this heat inform the Gallops design direction.
