...
### <a id="HallmarkImage"></a>Hallmark Image

The container image artifact within a [Hallmark](#Hallmark), tagged as `-image` in the [Depot's](#Depot) registry. Every [Ordain](#Ordain) mode produces a [Hallmark Image](#HallmarkImage) — [Conjured](#Conjure) from source, [Bound](#Bind) from upstream, or [Grafted](#Graft) from local. This is the artifact a [Retriever](#Retriever) [Summons](#Summon).

### <a id="HallmarkAbout"></a>Hallmark About

Software bill of materials for a [Hallmark](#Hallmark), tagged as `-about` in the [Depot's](#Depot) registry. Contains the SBOM (generated by syft) and build metadata recording how the image was produced. Created alongside the [Hallmark Image](#HallmarkImage) during [Ordination](#Ordain).
