...
:at_sessile_service:         <<term_sessile_service,Sessile Bottle Service>>
:at_agile_service:           <<term_agile_service,Agile Bottle Service>>
...
:at_enclave_network_s:       <<term_enclave_network,Enclave Network>>
...
:at_transit_network_name:    <<term_transit_network_name,Transit Network Name>>
:at_enclave_namespace_name:  <<term_enclave_namespace_name,Enclave Namespace Name>>
:at_enclave_network_name:    <<term_enclave_network_name,Enclave Network Name>>
...
:at_bottle_container_name:   <<term_bottle_container_name,Bottle Container Name>>
:at_sentry_container_name:   <<term_sentry_container_name,Sentry Container Name>>
:at_rbm_console:             <<term_rbm_console,RBM Console Makefile>>
:at_rbm_config_makefile:     <<term_rbm_config_makefile,RBM Config Makefile>>
:at_rbm_system:              <<term_rbm_system,RBM System>>
:at_rbm_system_p:            <<term_rbm_system,RBM System's>>
:at_rbm_secret:              <<term_rbm_secret,RBM Secret>>
:at_rbm_secret_s:            <<term_rbm_secret,RBM Secrets>>
:at_rbm_repo:                <<term_rbm_repo,RBM Repository>>
:at_user_repo:               <<term_user_repo,User Repository>>
:at_container_registry:      <<term_container_registry,Remote Container Registry>>
:at_startup_script:          <<term_startup_script,Startup Script>>
:at_startup_script_s:        <<term_startup_script,Startup Scripts>>
:at_user:                    <<term_user,User>>
:at_user_s:                  <<term_user,Users>>
:at_user_p:                  <<term_user,User's>>
:at_ebpf_program:            <<term_at_ebpf_program,eBPF Program>>
:at_stash_machine:           <<term_stash_machine,Stash Machine>>
:at_operational_machine:     <<term_operational_machine,Operational Machine>>
...
:st_dockerfile:              <<term_dockerfile,Dockerfile>>
:st_published_image:         <<term_published_image,Published Image>>
:st_published_image_s:       <<term_published_image,Published Images>>
:st_image:                   <<term_image,Container Image>>
:st_image_s:                 <<term_image,Container Images>>
:st_image_store:             <<term_image_store,Local Image Store>>
:st_port_map:                <<term_port_map,Port Map>>
:st_port_map_s:              <<term_port_map,Port Maps>>
:st_volume_mount:            <<term_volume_mount,Volume Mount>>
:st_volume_mount_s:          <<term_volume_mount,Volume Mounts>>

:opss_sentry_start:          <<term_opss_sentry_start,Sentry Start Rule>>
:opbs_bottle_start:          <<term_opbs_bottle_start,Sessile Bottle Start Rule>>
:opbr_bottle_run:            <<term_opbr_bottle_run,Agile Bottle Run Rule>>

:mkr_network_create:         <<term_mkr_network_create,Network Creation Sequence>>
:mkr_sentry_run:             <<term_mkr_sentry_run,Sentry Launch Sequence>>
:mkr_network_connect:        <<term_mkr_network_connect,Network Connection Sequence>>
:mkr_bottle_cleanup:         <<term_mkr_bottle_cleanup,Bottle Cleanup Sequence>>
:mkr_bottle_launch:          <<term_mkr_bottle_launch,Bottle Launch Sequence>>
:mkr_bottle_create:          <<term_mkr_bottle_create,Bottle Create Sequence>>
:mkr_command_exec:           <<term_mkr_command_exec,Command Execution Sequence>>

:ops_rbv_check:              <<term_ops_rbv_check,RBV Check Operation>>
:ops_rbv_mirror:             <<term_ops_rbv_mirror,RBV Mirror Operation>>

:mkc_interface_check:        <<term_mkc_interface_check,Interface Check Clause>>

:scr_security_config:        <<term_scr_security_config,Security Configuration Stage>>
:scr_iptables_init:          <<term_scr_iptables_init,IPTables Initialization Sequence>>
:scr_access_setup:           <<term_scr_access_setup,Access Control Setup Sequence>>
:scr_port_setup:             <<term_scr_port_setup,Port Configuration Sequence>>
:scr_dns_step:               <<term_scr_dns_step,DNS Configuration Sequence>>

:cfg_base_regime:           <<term_base_regime,Base Config Regime>>
:cfg_base_regime_s:         <<term_base_regime,Base Config Regimes>>
:cfg_station_regime:        <<term_station_regime,Station Config Regime>>
:cfg_station_regime_s:      <<term_station_regime,Station Config Regimes>>
:cfg_nameplate_regime:      <<term_nameplate_regime,Nameplate Config Regime>>
:cfg_nameplate_regime_s:    <<term_nameplate_regime,Nameplate Config Regimes>>
:cfg_regime_variable:       <<term_regime_variable,Config Regime Variable>>
:cfg_regime_variable_s:     <<term_regime_variable,Config Regime Variables>>

:cmk_discipline:             <<term_cmk_discipline,Console Makefile Discipline>>
:cmk_external_rule:          <<term_cmk_external_rule,External Rule>>
:cmk_external_rule_s:        <<term_cmk_external_rule,External Rules>>
:cmk_internal_rule:          <<term_cmk_internal_rule,Internal Rule>>
:cmk_internal_rule_s:        <<term_cmk_internal_rule,Internal Rules>>
:cmk_makefile:               <<term_cmk_makefile,Console Style Makefile>>
:cmk_clause:                 <<term_cmk_clause,Makefile Clause>>
:cmk_recipe_line:            <<term_cmk_recipe_line,Makefile Recipe Line>>
:cmk_recipe_line_s:          <<term_cmk_recipe_line,Makefile Recipe Lines>>
:cmk_probe_line:             <<term_cmk_probe_line,Makefile Probe Line>>
:cmk_probe_line_s:           <<term_cmk_probe_line,Makefile Probe Lines>>
:cmk_script:                 <<term_cmk_script,Console Support Script>>
:cmk_script_s:               <<term_cmk_script,Console Support Scripts>>
:cmk_script_line:            <<term_cmk_script_line,Console Script Line>>
:cmk_script_line_s:          <<term_cmk_script_line,Console Script Lines>>

:rbrr_dns_server:            <<term_rbrr_dns_server,RBRR_DNS_SERVER>>
:rbrr_nameplate_path:        <<term_rbrr_nameplate_path,RBRR_NAMEPLATE_PATH>>
:rbrr_registry_server:       <<term_rbrr_registry_server,RBRR_REGISTRY_SERVER>>
:rbrr_registry_owner:        <<term_rbrr_registry_owner,RBRR_REGISTRY_OWNER>>
:rbrr_registry_name:         <<term_rbrr_registry_name,RBRR_REGISTRY_NAME>>
:rbrr_github_pat_env:        <<term_rbrr_github_pat_env,RBRR_GITHUB_PAT_ENV>>
:rbrr_build_architectures:   <<term_rbrr_build_architectures,RBRR_BUILD_ARCHITECTURES>>
:rbrr_history_dir:           <<term_rbrr_history_dir,RBRR_HISTORY_DIR>>
:rbrr_chosen_podman_version: <<term_rbrr_chosen_podman_version,RBRR_CHOSEN_PODMAN_VERSION>>
:rbrr_chosen_vmimage_origin: <<term_rbrr_chosen_vmimage_origin,RBRR_CHOSEN_VMIMAGE_ORIGIN>>
:rbrr_chosen_vmimage_fqin:   <<term_rbrr_chosen_vmimage_fqin,RBRR_CHOSEN_VMIMAGE_FQIN>>
:rbrr_chosen_vmimage_sha:    <<term_rbrr_chosen_vmimage_sha,RBRR_CHOSEN_VMIMAGE_SHA>>
:rbrr_chosen_identity:       <<term_rbrr_chosen_identity,RBRR_CHOSEN_IDENTITY>>
:rbrr_stash_machine:         <<term_rbrr_stash_machine,RBRR_STASH_MACHINE>>
:rbrr_operational_machine:   <<term_rbrr_operational_machine,RBRR_OPERATIONAL_MACHINE>>
:rbrr_crane_tar_gz:          <<term_rbrr_crane_tar_gz,RBRR_CRANE_TAR_GZ>>

:rbrn_moniker:                    <<term_rbrn_moniker,RBRN_MONIKER>>
:rbrn_description:                <<term_rbrn_description,RBRN_DESCRIPTION>>
:rbrn_sentry_repo_path:           <<term_rbrn_sentry_repo_path,RBRN_SENTRY_REPO_PATH>>
:rbrn_bottle_repo_path:           <<term_rbrn_bottle_repo_path,RBRN_BOTTLE_REPO_PATH>>
:rbrn_sentry_image_tag:           <<term_rbrn_sentry_image_tag,RBRN_SENTRY_IMAGE_TAG>>
:rbrn_bottle_image_tag:           <<term_rbrn_bottle_image_tag,RBRN_BOTTLE_IMAGE_TAG>>
:rbrn_entry_enabled:              <<term_rbrn_entry_enabled,RBRN_ENTRY_ENABLED>>
:rbrn_entry_port_workstation:     <<term_rbrn_entry_port_workstation,RBRN_ENTRY_PORT_WORKSTATION>>
:rbrn_entry_port_enclave:         <<term_rbrn_entry_port_enclave,RBRN_ENTRY_PORT_ENCLAVE>>
:rbrn_uplink_dns_enabled:         <<term_rbrn_uplink_dns_enabled,RBRN_UPLINK_DNS_ENABLED>>
:rbrn_uplink_access_enabled:      <<term_rbrn_uplink_access_enabled,RBRN_UPLINK_ACCESS_ENABLED>>
:rbrn_uplink_dns_global:          <<term_rbrn_uplink_dns_global,RBRN_UPLINK_DNS_GLOBAL>>
:rbrn_uplink_access_global:       <<term_rbrn_uplink_access_global,RBRN_UPLINK_ACCESS_GLOBAL>>
:rbrn_uplink_allowed_cidrs:       <<term_rbrn_uplink_allowed_cidrs,RBRN_UPLINK_ALLOWED_CIDRS>>
:rbrn_uplink_allowed_domains:     <<term_rbrn_uplink_allowed_domains,RBRN_UPLINK_ALLOWED_DOMAINS>>
:rbrn_enclave_netmask:            <<term_rbrn_enclave_netmask,RBRN_ENCLAVE_NETMASK>>
:rbrn_enclave_base_ip:            <<term_rbrn_enclave_base_ip,RBRN_ENCLAVE_BASE_IP>>
:rbrn_enclave_sentry_ip:          <<term_rbrn_enclave_sentry_ip,RBRN_ENCLAVE_SENTRY_IP>>
:rbrn_volume_mounts:              <<term_rbrn_volume_mounts,RBRN_VOLUME_MOUNTS>>
...
Each
{at_bottle_service}
maintains these boundaries through:
...
* External access to services only permitted when {rbrn_entry_enabled} is true
...
If
{rbrn_entry_enabled}
is false, this sequence is skipped.
If
{rbrn_entry_enabled}
is true, this sequence configures service port mapping:

. DNAT Configuration in nat table:
* Create PREROUTING rule on eth0:
...
* Mark rule with comment "RBM-PORT-FORWARD"

. Filter Configuration:
* Add rule to RBM-INGRESS accepting:
** Interface eth0
** Destination port {rbrn_entry_port_workstation}
** Initial TCP connections only with connection tracking
* Add rule to RBM-FORWARD accepting TCP traffic with state matching:
** Interface eth1
** Source port
{rbrn_entry_port_enclave}
** Initial connections, related secondary connections, and established connections verified by connection tracking

==== Phase 3: {scr_access_setup}

If
{rbrn_uplink_access_enabled}
is false, this sequence:
...
[[term_rbrr_chosen_podman_version]]
...
[[term_rbrr_chosen_vmimage_origin]]
...
{at_workstation}.
Users control service configuration through
{at_nameplate_s}
and interact with services through controlled interfaces.

[[term_at_ebpf_program]]
{at_ebpf_program}::
...
[[term_rbrn_description]]
{rbrn_description}::
A human-readable explanation of the
{at_bottle_service_p}
purpose and function.

[[term_rbrn_sentry_repo_path]]
{rbrn_sentry_repo_path}::
The complete repository path where the
{at_sentry_image}
is stored in the
{at_container_registry}.

[[term_rbrn_bottle_repo_path]]
{rbrn_bottle_repo_path}::
The complete repository path where the
{at_bottle_image}
is stored in the
{at_container_registry}.

[[term_rbrn_sentry_image_tag]]
{rbrn_sentry_image_tag}::
The version identifier for the
{at_sentry_image}
to be deployed.

[[term_rbrn_bottle_image_tag]]
{rbrn_bottle_image_tag}::
The version identifier for the
{at_bottle_image}
to be deployed.

[[term_rbrn_entry_enabled]]
{rbrn_entry_enabled}::
A flag indicating whether the
{at_bottle_service}
should expose network ports through the
{at_sentry_container}.

[[term_rbrn_entry_port_workstation]]
{rbrn_entry_port_workstation}::
The network port number exposed on the
{at_transit_network}
when port service is enabled.

[[term_rbrn_entry_port_enclave]]
{rbrn_entry_port_enclave}::
...
[[term_rbrn_uplink_dns_enabled]]
{rbrn_uplink_dns_enabled}::
A flag determining whether the
{at_sentry_container}
allows any DNS resolution for its
{at_bottle_container}.
When false, the
...
When true, the
{at_sentry_container}
processes DNS queries according to either unrestricted rules
({rbrn_uplink_dns_global})
or domain-specific controls
({rbrn_uplink_allowed_domains}).

[[term_rbrn_uplink_access_enabled]]
{rbrn_uplink_access_enabled}::
A flag indicating whether protected IP access through the
{at_transit_network}
is enabled.

[[term_rbrn_uplink_dns_global]]
{rbrn_uplink_dns_global}::
A flag determining how the
{at_sentry_container}
filters DNS queries when
{rbrn_uplink_dns_enabled}
is true.
When false, the
{at_sentry_container}
