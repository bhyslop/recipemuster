...
.4+|**`RBRN_SENTRY_REPO_PATH`**
|Purpose|
Full repository path for
{at_sentry_image}
|Type|
{crg_atom_fqin}:
1-128 characters
...
.4+|**`RBRN_ENTRY_ENABLED`**
|Purpose|
Enable flag for user-initiated entry functionality
|Type|
{crg_atom_bool}
|Required|
Yes
...
.4+|**`RBRN_UPLINK_DNS_ENABLED`**
|Purpose|
Enable protected DNS resolution for bottle-initiated requests
|Type|
{crg_atom_bool}
|Required|
Yes
...
.4+|**`RBRN_UPLINK_ACCESS_ENABLED`**
|Purpose|
Enable protected IP access for bottle-initiated connections
|Type|
{crg_atom_bool}
|Required|
Yes
...
.4+|**`RBRN_UPLINK_DNS_GLOBAL`**
|Purpose|
Enable unrestricted DNS resolution for bottle-initiated requests
|Type|
{crg_atom_bool}
|Required|
Yes
...
.4+|**`RBRN_UPLINK_ACCESS_GLOBAL`**
|Purpose|
Enable unrestricted IP access for bottle-initiated connections
|Type|
{crg_atom_bool}
|Required|
Yes
...
{crg_list_cidr}
|Required|
When UPLINK_ACCESS_ENABLED=1 and UPLINK_ACCESS_GLOBAL=0
|Constraints|
...
{crg_list_domain}
|Required|
When UPLINK_DNS_ENABLED=1 and UPLINK_DNS_GLOBAL=0
|Constraints|
|===
