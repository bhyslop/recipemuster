...
:rbtga_ark_stamp:            <<rbtga_ark_stamp,Ark Stamp>>
...
{rbtga_ark_stamp}::
The timestamp-based identifier that uniquely identifies an
{rbtga_ark}
within a moniker namespace.
Format: `YYYYMMDDTHHMMSSZ` or similar timestamp pattern.
Combined with moniker to form complete artifact tags: `«MONIKER»:«ARK_STAMP»-image` and `«MONIKER»:«ARK_STAMP»-about`.
