...
[[rbrv_description]]
// ⟦axl_voices axrg_variable rbst_description⟧
{rbrv_description}::
Human-readable vessel documentation.

[[rbrv_bind_image]]
// ⟦axl_voices axrg_variable rbst_image_ref⟧
{rbrv_bind_image}::
Container image reference for binding vessels.

[[rbrv_conjure_dockerfile]]
// ⟦axl_voices axrg_variable rbst_path⟧
{rbrv_conjure_dockerfile}::
...
// ⟦axl_voices axrg_variable rbst_platform_list⟧
{rbrv_conjure_platforms}::
Target platform architectures for multi-platform builds.

[[rbrv_conjure_binfmt_policy]]
// ⟦axl_voices axrg_variable rbst_binfmt_policy⟧
{rbrv_conjure_binfmt_policy}::
