...
// Regime variable mappings
:rbrv_regime:                 <<rbrv_regime,RBRV_REGIME>>
:rbrv_sigil:                  <<rbrv_sigil,RBRV_SIGIL>>
:rbrv_description:            <<rbrv_description,RBRV_DESCRIPTION>>
:rbrv_bind_image:             <<rbrv_bind_image,RBRV_BIND_IMAGE>>
:rbrv_conjure_dockerfile:     <<rbrv_conjure_dockerfile,RBRV_CONJURE_DOCKERFILE>>
...
[[rbrv_sigil]]
// ⟦axl_voices axrg_variable rbst_xname axd_required⟧
{rbrv_sigil}::
Vessel identifier; basis for directory and ark naming.

[[rbrv_description]]
// ⟦axl_voices axrg_variable rbst_description axd_optional⟧
{rbrv_description}::
Human-readable vessel documentation.

[[rbrv_bind_image]]
// ⟦axl_voices axrg_variable rbst_image_ref axd_optional⟧
{rbrv_bind_image}::
Container image reference for binding vessels.

[[rbrv_conjure_dockerfile]]
// ⟦axl_voices axrg_variable rbst_path axd_optional⟧
{rbrv_conjure_dockerfile}::
Dockerfile path for conjuring vessels.

[[rbrv_conjure_bldcontext]]
// ⟦axl_voices axrg_variable rbst_path axd_optional⟧
{rbrv_conjure_bldcontext}::
Build context directory for conjuring.

[[rbrv_conjure_platforms]]
// ⟦axl_voices axrg_variable rbst_platform_list axd_optional⟧
{rbrv_conjure_platforms}::
Target platform architectures for multi-platform builds.

[[rbrv_conjure_binfmt_policy]]
// ⟦axl_voices axrg_variable rbst_binfmt_policy axd_optional⟧
{rbrv_conjure_binfmt_policy}::
...
{rbst_xname}::
Cross-context safe identifier.
1-64 characters; must start with letter; may contain letters, digits, underscores, and hyphens.
...
{rbst_path}::
File system path within the repository context.
May be absolute or relative; typically constructed from regime variables.
