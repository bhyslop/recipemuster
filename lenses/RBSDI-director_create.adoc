...
.. {rbbc_call}
link:https://cloud.google.com/secret-manager/docs/reference/rest/v1/projects.secrets/setIamPolicy[secrets.setIamPolicy] for `projects/{rbrr_depot_project_id}/secrets/RBGC_CBV2_API_TOKEN_SECRET_NAME`
.. Add `serviceAccount:«DIRECTOR_EMAIL»` with `roles/secretmanager.secretAccessor`
.. {rbbc_require}
