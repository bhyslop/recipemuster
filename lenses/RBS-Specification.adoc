...
:rbrn_entry_enabled:              <<rbrn_entry_enabled,RBRN_ENTRY_ENABLED>>
...
:rbrn_uplink_dns_enabled:         <<rbrn_uplink_dns_enabled,RBRN_UPLINK_DNS_ENABLED>>
:rbrn_uplink_access_enabled:      <<rbrn_uplink_access_enabled,RBRN_UPLINK_ACCESS_ENABLED>>
:rbrn_uplink_dns_global:          <<rbrn_uplink_dns_global,RBRN_UPLINK_DNS_GLOBAL>>
:rbrn_uplink_access_global:       <<rbrn_uplink_access_global,RBRN_UPLINK_ACCESS_GLOBAL>>
