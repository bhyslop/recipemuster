...
// ⟦axs_completion⟧
Successful execution creates depot infrastructure with configured build bucket, container repository, Mason service account, and Developer Connect connection (PENDING state) ready for
{rbtgo_depot_initialize}
and
{rbtr_governor}
creation.
