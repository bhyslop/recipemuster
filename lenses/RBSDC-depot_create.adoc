...
// ⟦axs_completion⟧ Successful execution creates depot infrastructure with configured build bucket, container repository, and Mason service account ready for governor creation.
