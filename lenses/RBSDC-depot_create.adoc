...
//axhos_step
[[rbtgo_depot_create_authenticate]]
{rbtgo_depot_create_authenticate}
. *Authenticate as
{rbtr_payor}*:
.. Execute
...
//axhos_step
[[rbtgo_depot_create_generate_project_id]]
{rbtgo_depot_create_generate_project_id}
...
//axhos_step
[[rbtgo_depot_create_link_billing]]
{rbtgo_depot_create_link_billing}
...
//axhos_step
[[rbtgo_depot_create_get_project_number]]
{rbtgo_depot_create_get_project_number}
...
//axhos_step
[[rbtgo_depot_create_enable_apis]]
{rbtgo_depot_create_enable_apis}
...
//axhos_step
[[rbtgo_depot_create_mason_permissions]]
{rbtgo_depot_create_mason_permissions}
. *Configure
{rbtr_mason}
Permissions*:
...
//axhos_step
[[rbtgo_depot_create_mason_impersonation]]
{rbtgo_depot_create_mason_impersonation}
...
//axhos_step
[[rbtgo_depot_create_devconnect_secrets]]
{rbtgo_depot_create_devconnect_secrets}
...
//axhoo_output
[[rbtgo_depot_create_config_display]]
{rbtgo_depot_create_config_display}
...
//axhoo_output
[[rbtgo_depot_create_tracking_update]]
{rbtgo_depot_create_tracking_update}
