...
[[rbrr_regime]]
// ⟦axl_voices axrg_regime axf_bash axrd_file_sourced⟧
{rbrr_regime}::
An
regime
...
// ⟦axl_voices axrg_variable axvr_broach axvr_validate axvr_render axtg_project_id⟧
{rbrr_depot_project_id}::
The
{gcp_service}
{gcp_project_id}
...
[[rbrr_gcp_region]]
// ⟦axl_voices axrg_variable axvr_broach axvr_validate axvr_render axtg_region⟧
{rbrr_gcp_region}::
The default
{gcp_service}
...
// ⟦axl_voices axrg_variable axvr_broach axvr_validate axvr_render axtu_path⟧
{rbrr_retriever_rbra_file}::
Path to an
{rbtgi_rbra_file}
stored in the
