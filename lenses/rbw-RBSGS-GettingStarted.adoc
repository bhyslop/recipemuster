...
* *{rbtr_payor}*: Creates and funds {rbtgi_depot_s}; creates {rbtr_governor_s}. Billing flows through the payor's linked account. Manual OAuth setup enables all subsequent automation.
* *{rbtr_governor}*: Administers credentials within a {rbtgi_depot}. Creates directors and retrievers via service account authentication.
