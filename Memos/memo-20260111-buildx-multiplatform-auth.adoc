...
docker buildx build \
  ...
  --tag ${_RBGY_MONIKER}:${CONSECRATION}-img \
...
crane push /workspace/oci-layout \
  "${_RBGY_GAR_LOCATION}-docker.pkg.dev/${_RBGY_GAR_PROJECT}/${_RBGY_GAR_REPOSITORY}/${_RBGY_MONIKER}:${CONSECRATION}-img" \
  --index
----
...
**Step 1: Derive consecration** (rbgjb01-derive-tag-base.sh)
----
CONSECRATION="$(date -u +%Y%m%dT%H%M%SZ)"
