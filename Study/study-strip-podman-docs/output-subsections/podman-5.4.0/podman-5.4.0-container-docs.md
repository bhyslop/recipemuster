# podman-5.4.0 Container Commands
...
-   *idmap*: If specified, create an idmapped mount to the target user
    ...
    idmaped file systems for unprivileged users. The idmap option
    supports a custom mapping that can be different than the user
    namespace used by the container. The mapping can be specified after
    the idmap option like: `idmap=uids=0-1-10#10-11-10;gids=0-100-10`.
    ...
    length of this mapping is given in the third value. Multiple ranges
    are separated with #. If the specified mapping is prepended with a
    \'@\' then the mapping is considered relative to the container user
    namespace. The host ID for the mapping is changed to account for the
    relative position of the container user in the container user
    namespace.
...
-   *idmap*: *true* or *false* (default if unspecified: *false*). If
    ...
    container. The idmap option is only supported by Podman in rootful
    mode.
...
Valid placeholders for the Go template are listed below:
  ...
  **Placeholder**            **Description**
  ...
  .IsInfra                   Is this an infra container? (string:
                             true/false)

  .IsService                 Is this a service container? (string:
                             true/false)
  ...
  .RestartCount              Number of times container has been restarted
                             (int)
  ...
  .SizeRw                    Size of upper (R/W) container layer, in bytes
                             \[1\]
  ...
  .UseImageHostname          Use /etc/hostname from the image if it exists?
                             (string: true/false)

                             

  .UseImageHosts             Use /etc/hosts from the image? (string:
                             true/false)
...
Valid filters are listed below:
  ...
  **Filter**   **Description**
  ...
  status       \[Status\] Container\'s status: \'created\', \'initialized\',
               \'exited\', \'paused\', \'running\', \'unknown\'
...
Updates the configuration of an existing container, allowing changes to
...
Changing this setting resets the timer, depending on the state of the
container.
