...
# VERSION STUDY DOCUMENTATION BLOCK
# =============================================================================
# Date: 2025-06-24 21:16:45 PDT
# 
# Podman Version: 5.5.2 (client) / 5.5.1 (server) (Built: Tue Jun 24 09:13:04 2025)
# VM Build Date: 2025-04-22 17:00:00.000000000 -0700
# Mode: Rootful (Rootful: true)
# 
# Command: podman -c pdvm-rbw run -d --name nsproto-bottle --network ns:/proc/1465/ns/net ghcr.io/bhyslop/recipemuster:bottle_ubuntu_test.20241207__190758
# 
# Expected Error from Next Command:
# Error: cannot find specified network namespace path: faccessat /proc/1465/ns/net: permission denied
# =============================================================================
