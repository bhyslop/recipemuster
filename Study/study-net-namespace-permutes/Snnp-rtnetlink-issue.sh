...
echo "SNNP: Get constants"
source "$SCRIPT_DIR/Snmp-constants.sh"
...
sleep 2
podman machine ssh ${MACHINE} "podman ps | grep ${SENTRY_CONTAINER} || (echo 'Container not running' && exit 1)"
