...
echo -e "${BOLD}Using podman unshare to create network namespace${NC}"
echo "RBNS-PODMAN-UNSHARE: Creating network namespace using podman unshare"

# Create a script that will run inside podman unshare to set up the namespace
snnp_machine_ssh "cat > /tmp/setup_netns.sh << 'EOF'
#!/bin/bash
set -e
...
# 
# Note: Even Podman's own unshare command cannot create network namespaces
# in rootful mode, indicating this is a fundamental limitation in Podman 5.3.2
# =============================================================================

# =============================================================================
# VERSION STUDY DOCUMENTATION BLOCK
# =============================================================================
# Date: 2025-06-24 19:09:34 PDT
# 
...
echo "RBNS-PODMAN-UNSHARE: Starting container with the prepared network namespace"
podman -c ${MACHINE} run -d                       \
