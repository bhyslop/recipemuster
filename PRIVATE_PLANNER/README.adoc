...
* TODO: Pull all env vars down
* TODO: MAYBE make dockerfiles crash if needed vars not set?

* TODO: Decide what to do around -> `rbm-P.SetupPodman.sh`

* TODO: Confirm current local function on `*srjcl*`
* TODO: Recast nameplates to makestyle
* TODO: Decide if NAMEPLATE_MONIKER ought to be an RBEV_ thing and apply
