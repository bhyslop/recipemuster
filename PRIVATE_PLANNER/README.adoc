...
* Write up gbc reqs for pinning within the runner, including:
   ...
   * syft
   * qemu, docker, buildx
* Assure plantuml container doesn't need volume mounts or external cidrs or access
* some sort of documentation of:
  http://localhost:8001/uml/SyfFKj2rKt3CoKnELR1Io4ZDoSbNACb8BKe50000
