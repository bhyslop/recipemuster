...
pub fn vofr_collect(
    ...
    for kit_id in managed_kits {
        ...
        // Public claude-{kit}-*.md guidance files ride along via the normal kit
        // walk above (they live in the kit root, not vov_veiled). No separate
        // template copy: CLAUDE.md content is @-included, never inlined.
