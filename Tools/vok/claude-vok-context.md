...
- **VOSO** → `vok/vov_veiled/VOSO-distribution.adoc` (Vox Obscura distribution-procedure subdoc — pure-consumer subdoc of VOS0 (include::'d under its == Operations branch, defines zero quoins); holds the release/install/uninstall procedure bodies. The operation quoins are defined at the VOS0 cosmology top.)
