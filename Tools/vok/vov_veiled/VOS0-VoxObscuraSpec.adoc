...
Whisper::for_kit("jjk")
    ...
    .concept_model("JJS0-GallopsData.adoc")
...
+
Naming: Keeps existing acronym (e.g., `JJS0-GallopsData.adoc`).
Registered in
{vose_whisper}
...
The
{vost_hallmark}
concept is shared with Job Jockey's `jjb:` commit format (documented in JJS0-GallopsData.adoc).
