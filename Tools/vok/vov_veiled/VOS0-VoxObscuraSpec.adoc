...
VOS section headers voice `axho_*` motifs for procedure documentation structure.

[[voss_inputs]]
//axl_voices axhop_parameter
{voss_inputs}::
Section header for operation input parameters.

[[voss_behavior]]
//axl_voices axhos_step
{voss_behavior}::
Section header for operation behavior steps.

[[voss_outputs]]
//axl_voices axhoo_output
{voss_outputs}::
Section header for operation outputs and artifacts.

[[voss_completion]]
//axl_voices axhoc_completion
{voss_completion}::
