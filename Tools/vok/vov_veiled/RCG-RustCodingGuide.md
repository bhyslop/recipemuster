...
The allocation instance — *reference the home, don't recreate* (values → constants, concepts → quoin-refs) — is its own language-neutral guide: see **ACG** (`Tools/cmk/vov_veiled/ACG-AllodialCodingGuide.md`). Constant Discipline and String Boundary Discipline above are its Rust instances.
