...
- **Phase ladder**: A long arc shaped as a succession of heats, one rung apiece — the ladder recorded in the standing heat's paddock, rungs named but detailed only once their predecessor lands. Three hard laws: a phase boundary is a **slated pace, never paddock prose** (a pace blocks a clean retirement; prose does not); findings travel **verbatim**, proven by byte diff against the source, never re-glossed or condensed; **only live findings travel** — a carry is a liveness filter, and a retired paddock is provenance, never authority. Read the full doctrine — JJS0 "The Phase Ladder" (Design Principles) — before grooming a heat whose paddock shows a ladder, or before cutting a heat that will hand work forward.
