...
fn zjjrx_run_garland(args: zjjrx_GarlandArgs) -> i32 {
    use crate::jjrg_gallops::jjrg_GarlandArgs as LibGarlandArgs;
    use std::path::Path;
...
fn zjjrx_run_restring(args: zjjrx_RestringArgs) -> i32 {
    use crate::jjrg_gallops::jjrg_RestringArgs as LibRestringArgs;
    ...
    let coronets_json = match read_stdin() {
        Ok(s) => s,
        Err(e) => {
