...
Unlike
{jjdo_garland}
which has specific ceremony semantics (garlanding, furlough, filtering by state),
{jjdo_restring}
  ...
  "drafted": [
    {
      "old_coronet": "AFAAb",
      "new_coronet": "AGABd",
      "silks": "implement-bulk-draft",
      "state": "bridled",
      "spec": "Implement jjx_restring operation following jjx_draft pattern..."
    },
    {
      "old_coronet": "AFAAc",
      "new_coronet": "AGABe",
      "silks": "test-restring-edge-cases",
      "state": "rough",
      "spec": "Add tests for empty source, all paces transferred, ordering preservation..."
    }
  ]
}
----
...
| "Cannot draft paces to same heat"
