...
// Operations
:jjdo_chalk:          <<jjdo_chalk,jjx_mark>>
:jjdo_draft:          <<jjdo_draft,jjx_relocate>>
:jjdo_furlough:       <<jjdo_furlough,jjx_alter>>
:jjdo_garland:        <<jjdo_garland,jjx_continue>>
:jjdo_get_coronets:   <<jjdo_get_coronets,jjx_get_coronets>>
:jjdo_get_spec:       <<jjdo_get_spec,jjx_get_brief>>
:jjdo_landing:        <<jjdo_landing,jjx_landing>>
:jjdo_muster:         <<jjdo_muster,jjx_list>>
:jjdo_nominate:       <<jjdo_nominate,jjx_create>>
:jjdo_notch:          <<jjdo_notch,jjx_record>>
:jjdo_parade:         <<jjdo_parade,jjx_show>>
:jjdo_rail:           <<jjdo_rail,jjx_reorder>>
:jjdo_rein:           <<jjdo_rein,jjx_log>>
:jjdo_restring:       <<jjdo_restring,jjx_transfer>>
:jjdo_retire:         <<jjdo_retire,jjx_archive>>
:jjdo_saddle:         <<jjdo_saddle,jjx_orient>>
:jjdo_scout:          <<jjdo_scout,jjx_search>>
:jjdo_slate:          <<jjdo_slate,jjx_enroll>>
...
* *warrant* — the presentation term for the {jjdkm_direction} field. Execution guidance for autonomous operation. Used in CLI output labels and slash command descriptions. The JSON schema field remains `direction`.
