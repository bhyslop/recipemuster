...
Upper API verbs map horse racing vocabulary to {jjdx_cli} operations.
Some verbs map directly to a single operation; others orchestrate multiple operations.
