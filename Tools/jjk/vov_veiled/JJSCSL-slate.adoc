...
//axd_required
* {jjda_silks}
(may be omitted when {jjdxo_gazette} contains `jjezs_slate` input; silks is parsed from gazette lede)
...
{jjdkr_tack}
(may be omitted when {jjdxo_gazette} contains `jjezs_slate` input; docket is parsed from gazette content)
