...
Contains {gadwf_type} field set to "debug_output", {gadwf_debug_type} identifying the artifact type, {gadwf_content} with HTML or JSON payload, {gadwf_filename_pattern} for file naming, and {gadwf_source_files} array for debug context.
...
Semantic string values indicate artifact type: "from-dom-structure", "to-dom-structure", "diff-operations", "from-route-mapping", "to-route-mapping", "prototype-output", "dual-output", etc.
