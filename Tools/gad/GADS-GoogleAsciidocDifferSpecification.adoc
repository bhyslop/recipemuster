...
{gadic_route_start_marker}::
HTML marker element inserted before operation scope during rendering, anchors navigation links to visual change location.

[[gadic_route_end_marker]]
{gadic_route_end_marker}::
HTML marker element inserted after operation scope during rendering, terminates visual change indication region.
