...
[[gadvd_change_pane]]
{gadvd_change_pane}::
The bottom pane in {gadi_dual_view} displaying details for each {gadis_change} in the current comparison.
Shows all {gaddo_operation} entries from both {gadis_forward_list} and {gadis_reverse_list} that comprise each {gadis_change}, enabling inspection of how operations correlate between the forward and reverse directions.
