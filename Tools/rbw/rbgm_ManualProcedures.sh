...
rbgm_payor_establish() {
  ...
  zrbgm_d      "      - Project name: Recipe Bottle Payor"
  zrbgm_d      "      - Project ID: " "${RBRP_PAYOR_PROJECT_ID}"
  zrbgm_d      "   5. If project is NOT listed and billing needs to be enabled:"
  zrbgm_d      "      - Go to: https://console.cloud.google.com/project/settings/settings?project=${RBRP_PAYOR_PROJECT_ID}"
  zrbgm_dm     "      - Look for billing section and click " "Link a Billing Account"
  ...
  zrbgm_d      "      2. Scroll down to section " "Test users"
  zrbgm_dm     "      3. Click " "+ Add users"
  zrbgm_d      "      4. Right-side panel titled " "Add Users" " slides in"
  zrbgm_dm     "      5. Enter your email address in the field"
