...
rbgp_depot_create() {
  ...
  buc_bare "  readonly RBRR_DEPOT_PROJECT_ID=${z_depot_project_id}"
  buc_bare "  readonly RBRR_GCP_REGION=${z_region}"
  buc_bare "  readonly RBRR_GAR_REPOSITORY=${z_repository_name}"
  buc_bare "  readonly RBRR_CBV2_CONNECTION_NAME=${z_cbv2_connection_name}"
  buc_bare "  readonly RBRR_GCB_WORKER_POOL=${z_pool_resource}"
