...
zrbrn_kindle() {
  ...
  buv_env_fqin        RBRN_SENTRY_MONIKER        1    128
  buv_env_fqin        RBRN_BOTTLE_MONIKER        1    128
  ...
  ZRBRN_ROLLUP+="RBRN_SENTRY_MONIKER='${RBRN_SENTRY_MONIKER}' "
  ZRBRN_ROLLUP+="RBRN_BOTTLE_MONIKER='${RBRN_BOTTLE_MONIKER}' "
  ...
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_SENTRY_MONIKER=${RBRN_SENTRY_MONIKER}")
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_BOTTLE_MONIKER=${RBRN_BOTTLE_MONIKER}")
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_SENTRY_IMAGE_TAG=${RBRN_SENTRY_IMAGE_TAG}")
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_BOTTLE_IMAGE_TAG=${RBRN_BOTTLE_IMAGE_TAG}")
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_ENTRY_ENABLED=${RBRN_ENTRY_ENABLED}")
  ...
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_UPLINK_DNS_ENABLED=${RBRN_UPLINK_DNS_ENABLED}")
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_UPLINK_ACCESS_ENABLED=${RBRN_UPLINK_ACCESS_ENABLED}")
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_UPLINK_DNS_GLOBAL=${RBRN_UPLINK_DNS_GLOBAL}")
  ZRBRN_DOCKER_ENV+=("-e" "RBRN_UPLINK_ACCESS_GLOBAL=${RBRN_UPLINK_ACCESS_GLOBAL}")
