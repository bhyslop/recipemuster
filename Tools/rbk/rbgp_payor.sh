...
rbgp_brevet() {
  ...
  z_token=$(rba_don_capture "${RBCC_mantle_governor}") \
    || buc_die_now "Failed to don the governor mantle — avow if the ${RBCC_noun_sederunt} lapsed, or brevet this identity onto the governor mantle if admission is denied"
