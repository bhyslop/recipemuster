...
rbho_start_here() {
  ...
  buh_line "      The pluml Crucible deliberately mixes a kludged Sentry with"
  buh_line "      a bound Bottle — two ordain modes in one Crucible is the"
  ...
  buh_line "      Requires: Director credentials, a provisioned Depot, and Your First Crucible (kludged Sentry available) or Your First Cloud Build completed."
