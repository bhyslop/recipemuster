...
rbhp_establish() {
  ...
  buh_line     "   The glob assumes one freshly downloaded client_secret_*.json in"
  buh_line     "   ~/Downloads. If it saved elsewhere, or more than one exists (e.g."
  buh_line     "   after rotating a compromised secret), pass its exact path instead."
