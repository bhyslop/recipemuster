...
rbhp_establish() {
  ...
  buyy_cmd_yawp "${RBGC_PAYOR_APP_NAME}"; local -r z_cmd_app_name_picker="${z_buym_yelp}"
  buh_line     "   2. The page is correct when the ${z_ui_project_picker} button reads ${z_cmd_app_name_picker}"
