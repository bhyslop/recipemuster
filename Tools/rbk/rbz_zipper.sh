...
zrbz_kindle() {
  ...
  buz_enroll RBZ_JETTISON_IMAGE             "rbw-DJ"       "${z_mod}" "rbf_jettison"
  buz_enroll RBZ_WREST_IMAGE               "rbw-Rw"       "${z_mod}" "rbf_wrest"
  buz_enroll RBZ_PLUMB_FULL               "rbw-RpF"      "${z_mod}" "rbf_plumb_full"
  buz_enroll RBZ_PLUMB_COMPACT            "rbw-Rpc"      "${z_mod}" "rbf_plumb_compact"
