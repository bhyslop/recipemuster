...
# Build-host primitives (wait-build-completion, git-metadata, write-script-body,
# native-path) relocated to the rbfcb_ cluster; sourced here so every rbfc
# consumer reaches them unchanged.
