...
rbld_immure() {
  ...
  test -n "${z_substrate_reliquary}" \
    || buc_reject "${BUBC_band_unseised}" "RBRR_SUBSTRATE_RELIQUARY is unseised — capture a reliquary conclave and seise it (rbw-rrs) before an immure substrate capture"
