...
pub const RBTDGC_NOVATE_SEDERUNT: &str = "rbw-aN";
pub const RBTDGC_ESPY_SEDERUNT: &str = "rbw-as";
...
pub const RBTDGC_PAYOR_ORGANIZATION: &str = "rbw-gPO";
...
pub const RBTDGC_SEISE_SUBSTRATE: &str = "rbw-rrs";
pub const RBTDGC_RENDER_DEPOT: &str = "rbw-rdr";
pub const RBTDGC_VALIDATE_DEPOT: &str = "rbw-rdv";
pub const RBTDGC_INCUSE_DEPOT: &str = "rbw-rdi";
pub const RBTDGC_COLLATE_DEPOT: &str = "rbw-rdc";
...
pub const RBTDGC_BAND_CLEAN_TREE: i32 = 108;
