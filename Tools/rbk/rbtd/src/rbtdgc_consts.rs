...
pub const BUWGC_RN_VALIDATE: &str = "buw-rnv";
pub const BUWGC_RN_RENDER: &str = "buw-rnr";
pub const BUWGC_RN_LIST: &str = "buw-rnl";
pub const BUWGC_RP_VALIDATE: &str = "buw-rpv";
pub const BUWGC_RP_RENDER: &str = "buw-rpr";
pub const BUWGC_RP_LIST: &str = "buw-rpl";
pub const BUWGC_DELAY: &str = "buw-xd";
pub const BUWGC_BAND_CHAIN: &str = "buw-xb";
pub const BUWGC_SELF_TEST: &str = "buw-st";
pub const BUWGC_HJ0_TOP: &str = "buw-hj0";
pub const BUWGC_HJW_WINDOWS: &str = "buw-hjw";
pub const BUWGC_HJM_MACOS: &str = "buw-hjm";
pub const BUWGC_HJL_LINUX: &str = "buw-hjl";
pub const BUWGC_JW_KNOCK: &str = "buw-jwk";
pub const BUWGC_JW_COMMAND_FILE: &str = "buw-jwc";
pub const BUWGC_JW_INTERACTIVE: &str = "buw-jws";
pub const BUWGC_JP_CAPARISON_WIN: &str = "buw-jpCW";
pub const BUWGC_JP_CAPARISON_MAC: &str = "buw-jpCM";
pub const BUWGC_JP_CAPARISON_LIN: &str = "buw-jpCL";
pub const BUWGC_JP_PRIVILEGED_SSH: &str = "buw-jpS";
pub const BUWGC_JP_GARRISON_BASH: &str = "buw-jpGb";
pub const BUWGC_JP_GARRISON_CYGWIN: &str = "buw-jpGc";
pub const BUWGC_JP_GARRISON_WSL: &str = "buw-jpGw";
...
pub const RBTDGC_RBRF_FILE: &str = "rbmm_moorings/rbrf.env";
