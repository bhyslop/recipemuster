...
pub const RBTDGC_ENROBE_GOVERNOR: &str = "rbw-aE";
pub const RBTDGC_ENROBE_RETRIEVER: &str = "rbw-arE";
pub const RBTDGC_ENROBE_DIRECTOR: &str = "rbw-adE";
pub const RBTDGC_DEFROCK_RETRIEVER: &str = "rbw-arF";
pub const RBTDGC_DEFROCK_DIRECTOR: &str = "rbw-adF";
