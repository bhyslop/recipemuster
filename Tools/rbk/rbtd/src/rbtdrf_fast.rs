...
pub static RBTDRF_SECTIONS_ENROLLMENT_VALIDATION: &[rbtdre_Section] = &[
    rbtdre_Section {
        ...
        cases: &[
            rbtdre_Case { name: "ev-string-valid", func: rbtdrf_ev_string_valid },
            rbtdre_Case { name: "ev-string-empty-optional", func: rbtdrf_ev_string_empty_optional },
            rbtdre_Case { name: "ev-string-too-short", func: rbtdrf_ev_string_too_short },
            rbtdre_Case { name: "ev-string-too-long", func: rbtdrf_ev_string_too_long },
            rbtdre_Case { name: "ev-string-empty-required", func: rbtdrf_ev_string_empty_required },
            rbtdre_Case { name: "ev-xname-valid", func: rbtdrf_ev_xname_valid },
            rbtdre_Case { name: "ev-xname-invalid", func: rbtdrf_ev_xname_invalid },
            rbtdre_Case { name: "ev-gname-valid", func: rbtdrf_ev_gname_valid },
            rbtdre_Case { name: "ev-gname-invalid", func: rbtdrf_ev_gname_invalid },
            rbtdre_Case { name: "ev-fqin-valid", func: rbtdrf_ev_fqin_valid },
            rbtdre_Case { name: "ev-fqin-invalid", func: rbtdrf_ev_fqin_invalid },
        ],
    },
    rbtdre_Section {
        name: "ev-choice-types",
        cases: &[
            rbtdre_Case { name: "ev-bool-valid", func: rbtdrf_ev_bool_valid },
            rbtdre_Case { name: "ev-bool-invalid", func: rbtdrf_ev_bool_invalid },
            rbtdre_Case { name: "ev-bool-empty", func: rbtdrf_ev_bool_empty },
            rbtdre_Case { name: "ev-enum-valid", func: rbtdrf_ev_enum_valid },
            rbtdre_Case { name: "ev-enum-invalid", func: rbtdrf_ev_enum_invalid },
            rbtdre_Case { name: "ev-enum-empty", func: rbtdrf_ev_enum_empty },
        ],
    },
    rbtdre_Section {
        name: "ev-numeric-types",
        cases: &[
            rbtdre_Case { name: "ev-decimal-valid", func: rbtdrf_ev_decimal_valid },
            rbtdre_Case { name: "ev-decimal-below", func: rbtdrf_ev_decimal_below },
            rbtdre_Case { name: "ev-decimal-above", func: rbtdrf_ev_decimal_above },
            rbtdre_Case { name: "ev-decimal-empty", func: rbtdrf_ev_decimal_empty },
            rbtdre_Case { name: "ev-ipv4-valid", func: rbtdrf_ev_ipv4_valid },
            rbtdre_Case { name: "ev-ipv4-invalid", func: rbtdrf_ev_ipv4_invalid },
            rbtdre_Case { name: "ev-port-valid", func: rbtdrf_ev_port_valid },
            rbtdre_Case { name: "ev-port-invalid", func: rbtdrf_ev_port_invalid },
        ],
    },
    rbtdre_Section {
        name: "ev-reference-types",
        cases: &[
            rbtdre_Case { name: "ev-odref-valid", func: rbtdrf_ev_odref_valid },
            rbtdre_Case { name: "ev-odref-no-digest", func: rbtdrf_ev_odref_no_digest },
            rbtdre_Case { name: "ev-odref-malformed", func: rbtdrf_ev_odref_malformed },
            rbtdre_Case { name: "ev-odref-empty", func: rbtdrf_ev_odref_empty },
        ],
    },
    rbtdre_Section {
        name: "ev-list-types",
        cases: &[
            rbtdre_Case { name: "ev-list-string-valid", func: rbtdrf_ev_list_string_valid },
            rbtdre_Case { name: "ev-list-string-empty", func: rbtdrf_ev_list_string_empty },
            rbtdre_Case { name: "ev-list-string-bad-item", func: rbtdrf_ev_list_string_bad_item },
            rbtdre_Case { name: "ev-list-ipv4-valid", func: rbtdrf_ev_list_ipv4_valid },
            rbtdre_Case { name: "ev-list-ipv4-invalid", func: rbtdrf_ev_list_ipv4_invalid },
            rbtdre_Case { name: "ev-list-ipv4-empty", func: rbtdrf_ev_list_ipv4_empty },
            rbtdre_Case { name: "ev-list-gname-valid", func: rbtdrf_ev_list_gname_valid },
            rbtdre_Case { name: "ev-list-gname-invalid", func: rbtdrf_ev_list_gname_invalid },
        ],
    },
    rbtdre_Section {
        name: "ev-gating",
        cases: &[
            rbtdre_Case { name: "ev-gate-active-valid", func: rbtdrf_ev_gate_active_valid },
            rbtdre_Case { name: "ev-gate-active-invalid", func: rbtdrf_ev_gate_active_invalid },
            rbtdre_Case { name: "ev-gate-inactive", func: rbtdrf_ev_gate_inactive },
            rbtdre_Case { name: "ev-gate-multi", func: rbtdrf_ev_gate_multi },
        ],
    },
    rbtdre_Section {
        name: "ev-enforce-report",
        cases: &[
            rbtdre_Case { name: "ev-enforce-all-pass", func: rbtdrf_ev_enforce_all_pass },
            rbtdre_Case { name: "ev-enforce-first-bad", func: rbtdrf_ev_enforce_first_bad },
            rbtdre_Case { name: "ev-report-all-pass", func: rbtdrf_ev_report_all_pass },
            rbtdre_Case { name: "ev-report-mixed", func: rbtdrf_ev_report_mixed },
            rbtdre_Case { name: "ev-report-gated", func: rbtdrf_ev_report_gated },
            rbtdre_Case { name: "ev-multiscope", func: rbtdrf_ev_multiscope },
        ],
    },
];
...
pub static RBTDRF_SECTIONS_REGIME_VALIDATION: &[rbtdre_Section] = &[
    rbtdre_Section {
        ...
        cases: &[
            rbtdre_Case { name: "rv-rbrr-missing-project-id", func: rbtdrf_rv_rbrr_missing_project_id },
            rbtdre_Case { name: "rv-rbrr-bad-timeout", func: rbtdrf_rv_rbrr_bad_timeout },
            rbtdre_Case { name: "rv-rbrr-bad-pool-stem", func: rbtdrf_rv_rbrr_bad_pool_stem },
            rbtdre_Case { name: "rv-rbrr-unexpected-var", func: rbtdrf_rv_rbrr_unexpected_var },
            rbtdre_Case { name: "rv-rbrr-bad-vessel-dir", func: rbtdrf_rv_rbrr_bad_vessel_dir },
            rbtdre_Case { name: "rv-rbrr-bad-secrets-dir", func: rbtdrf_rv_rbrr_bad_secrets_dir },
        ],
    },
    rbtdre_Section {
        name: "rv-rbrv-negative",
        cases: &[
            rbtdre_Case { name: "rv-rbrv-missing-sigil", func: rbtdrf_rv_rbrv_missing_sigil },
            rbtdre_Case { name: "rv-rbrv-no-bind-image", func: rbtdrf_rv_rbrv_no_bind_image },
            rbtdre_Case { name: "rv-rbrv-unexpected-var", func: rbtdrf_rv_rbrv_unexpected_var },
            rbtdre_Case { name: "rv-rbrv-partial-conjure", func: rbtdrf_rv_rbrv_partial_conjure },
        ],
    },
    rbtdre_Section {
        name: "rv-rbrn-negative",
        cases: &[
            rbtdre_Case { name: "rv-rbrn-missing-moniker", func: rbtdrf_rv_rbrn_missing_moniker },
            rbtdre_Case { name: "rv-rbrn-invalid-runtime", func: rbtdrf_rv_rbrn_invalid_runtime },
            rbtdre_Case { name: "rv-rbrn-invalid-entry-mode", func: rbtdrf_rv_rbrn_invalid_entry_mode },
            rbtdre_Case { name: "rv-rbrn-invalid-dns-mode", func: rbtdrf_rv_rbrn_invalid_dns_mode },
            rbtdre_Case { name: "rv-rbrn-invalid-access-mode", func: rbtdrf_rv_rbrn_invalid_access_mode },
            rbtdre_Case { name: "rv-rbrn-port-conflict", func: rbtdrf_rv_rbrn_port_conflict },
            rbtdre_Case { name: "rv-rbrn-unexpected-var", func: rbtdrf_rv_rbrn_unexpected_var },
            rbtdre_Case { name: "rv-rbrn-bad-ip", func: rbtdrf_rv_rbrn_bad_ip },
        ],
    },
    rbtdre_Section {
        name: "rv-positive",
        cases: &[
            rbtdre_Case { name: "rv-rbrr-repo", func: rbtdrf_rv_rbrr_repo },
            rbtdre_Case { name: "rv-rbrv-all-vessels", func: rbtdrf_rv_rbrv_all_vessels },
            rbtdre_Case { name: "rv-rbrn-all-nameplates", func: rbtdrf_rv_rbrn_all_nameplates },
        ],
    },
];
...
pub static RBTDRF_SECTIONS_REGIME_SMOKE: &[rbtdre_Section] = &[rbtdre_Section {
    name: "regime-smoke",
    cases: &[
        rbtdre_Case { name: "rs-burc", func: rbtdrf_rs_burc },
        rbtdre_Case { name: "rs-burs", func: rbtdrf_rs_burs },
        rbtdre_Case { name: "rs-rbrn", func: rbtdrf_rs_rbrn },
        rbtdre_Case { name: "rs-rbrr", func: rbtdrf_rs_rbrr },
        rbtdre_Case { name: "rs-rbrv", func: rbtdrf_rs_rbrv },
        rbtdre_Case { name: "rs-rbrp", func: rbtdrf_rs_rbrp },
        rbtdre_Case { name: "rs-burd", func: rbtdrf_rs_burd },
    ],
}];
