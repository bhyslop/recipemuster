...
{rbtr_payor})
// roles/cloudbuild.connectionViewer eliminated (₣Av) — CB v2 connections no longer used
...
// CB v2 Connection Viewer verification step eliminated (₣Av) — CB v2 connections no longer used
