...
timeline relocated to RBSPH-ProjectHistory.adoc. Requires RBS0-SpecTop.adoc mapping
...
image::diagrams/rbm-abstract-drawio.svg[RBM Architecture,600,400,align="center"]
