...
rbmp_show_setup() {
  ...
  zrbmp_sect   "Google Cloud Platform Setup"
  
  zrbmp_subsec "Overview"
  ...
  zrbmp_sect   "Manual Provisioner Setup Procedure"
  ...
  zrbmp_subsub "4. Generate Service Account Key"
  ...
  zrbmp_subsub "5. Configure Local Environment"
...
rbmp_show_teardown() {
  ...
  zrbmp_sect   "Provisioner Teardown Procedure"
