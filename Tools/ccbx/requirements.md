...
## Usage Instructions
1. For filesystem permission compatibility, provide host user's UID/GID as environment variables when building
2. Build and start: `docker-compose up -d`
3. SSH access: `ssh -p 8888 claude@localhost`
4. Stop: `docker-compose down`
5. Rebuild after Dockerfile changes: `docker-compose build --no-cache`
