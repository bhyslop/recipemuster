...
: ${RBRN_ENCLAVE_SENTRY_IP:?}   && echo "RSNS0: RBRN_ENCLAVE_SENTRY_IP   = ${RBRN_ENCLAVE_SENTRY_IP}"
: ${RBRN_ENCLAVE_NETMASK:?}     && echo "RSNS0: RBRN_ENCLAVE_NETMASK     = ${RBRN_ENCLAVE_NETMASK}"
...
sudo nsenter -t $SENTRY_PID -n ip addr add ${RBRN_ENCLAVE_SENTRY_IP}/${RBRN_ENCLAVE_NETMASK} dev eth1 || exit 73
