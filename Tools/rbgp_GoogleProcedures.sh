...
rbgp_show_setup() {
  ...
  zrbgp_nw     "   3. At top, click " "+ CREATE SERVICE ACCOUNT"
  zrbgp_n      "   4. Service account details:"
  ...
  zrbgp_nw     "   5. Click -> " "Create and continue"
  zrbgp_nwnw   "   6. At " "Permissions (optional)" " pick dropdown " "Select a role"
  zrbgp_nc     "      - In filter box, type: " "owner"
  zrbgp_nwnw   "      - Select: " "Basic" " -> " "Owner"
  zrbgp_nw     "   7. Click -> " "Continue"
  zrbgp_nwnw   "   8. Skip " "Principals with access" " by clicking -> " "Done"
  zrbgp_e
