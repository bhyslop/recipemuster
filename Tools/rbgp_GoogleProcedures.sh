...
rbgp_show_setup() {
  ...
  zrbgp_e
  zrbgp_s2     "4. Navigate to Service Accounts:"
  ...
  zrbgp_nw     "   2. If prompted about APIs, click -> " "Enable API"
  zrbgp_n      "      TODO: This step is brittle - enabling IAM API may happen automatically or be blocked by org policy."
  zrbgp_nw     "   3. Wait for " "Identity and Access Management (IAM) API to enable"
  zrbgp_e
  ...
  zrbgp_nw     "   5. Click -> " "Continue"
  zrbgp_nwnw   "   6. Skip " "Principals with access" " by clicking -> " "Done"
  zrbgp_e
