...
RBS_PREFIX := RBS_  # Regime Bottle Service prefix
RBN_PREFIX := RBN_  # Recipe Bottle Nameplate prefix (Assignment prefix)
...
zrbs_define_rule:
	...
	@echo "$RBN_PORT_ENABLED           # Set to 1 to enable port service"
	...
	@echo "RBN_OUTREACH_ENABLED       # Set to 1 to enable internet access"
	...
	@echo "RBN_AUTOURL_ENABLED        # Set to 1 to enable URL auto-open"
...
zrbs_validate_outreach_1:
	...
	@echo "$(RBN_OUTREACH_CIDR)" | grep -E '^([0-9]{1,3}\.){3}[0-9]{1,3}/[0-9]{1,2}$$' || (echo "Error: RBN_OUTREACH_CIDR must be valid CIDR notation" && exit 1)
