...
* `rbw-B.ConnectBottle.tadmor.sh` — same, with imprint specifying target
...
Examples:
+
* `tadmor` in `rbw-B.ConnectBottle.tadmor.sh`
...
. User invokes launcher: `./tt/rbw-B.ConnectBottle.tadmor.sh`
