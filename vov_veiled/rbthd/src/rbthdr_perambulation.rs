...
pub const RBTHDR_ROWS: &[(&str, rbthdr_Disposition)] = &[
    ...
    ("rbmm_moorings/rben_fdkyclk/", Ship),
    ("rbmm_moorings/rben_ccyolo/", Ship),
    ("rbmm_moorings/rben_moriah/", Ship),
    ("rbmm_moorings/rben_nineveh/", Ship),
    ("rbmm_moorings/rben_pluml/", Ship),
    ("rbmm_moorings/rben_srjcl/", Ship),
    ("rbmm_moorings/rben_tadmor/", Ship),
